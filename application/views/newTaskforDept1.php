<div id="Dept1AddNew" class="modal fade">
      ...
      <div class="modal-body">
        ...
        <form enctype="multipart/form-data" action="../events/add" method="post">
              ...
              <div>
                ...
                <select data-department="1" name='project_task_select'>
                <?php 
                $first_task = 0;
                foreach ($project_tasks_data as $task){
                  if($task->d_id == 1&&($task->start_time == null||$task->start_time == "")) {
              ...
              <div>
                ...
                ?>
                <label>Select Status of this task:</label>
