<div id="Dept2AddNew" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
        //echo $counter[1];
        //echo $counter_total[1];
        if($counter2[1]==$counter_total[1]) {?>
        <div>No more task for this department</div>
        <?php }else {?>
        <form enctype="multipart/form-data" action="../events/add" method="post">
              <input type="hidden" name= "project_id" value="<?php echo $project_id?>">
              <div>
                <select data-department="2" name='project_task_select'>
                <?php 
                $first_task = 0;
                foreach ($project_tasks_data as $task){
                  if($task->d_id == 2&&($task->start_time == null||$task->start_time == "")) {
              ...
              <div>
                ...
                ?>
                <select data-department="1" name='status_select'>
                <?php 
